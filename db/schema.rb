...
ActiveRecord::Schema.define(version: 20160920160208) do
  ...
  create_table "trips", force: :cascade do |t|
    ...
    t.datetime "updated_at",                                      null: false
    t.string   "status"
    t.string   "trip_image_file_name"
    t.string   "trip_image_content_type"
    t.integer  "trip_image_file_size"
    t.datetime "trip_image_updated_at"
